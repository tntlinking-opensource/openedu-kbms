...
public class CheckoutFileType {
    ...
    //所有合法的文件后缀
    public static String res_fileType = ".jpg|.png|.bmp|.txt|.doc|.docx|.xls|.xlsx|.ppt|.pptx|.pdf|.rtf|.rar|.zip|.mp4|.mpeg|.avi|.wmv|.mpg|";
    //非法文件后缀
    //public static String f_res_fileType = "jsp|exe|java|class|html|xml|asp|php";
     ...
     * @return boolean
     */
    public static boolean getUpFilelegitimacyFlag(File attachDoc) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println(getUpFilelegitimacyFlag(fff));
