...
<head>
	<meta charset="utf-8">
	<title></title>
	<link rel="stylesheet" type="text/css" href="${base}/mainface/newlogin/css/reset.css">
	<link rel="stylesheet" type="text/css" href="${base}/mainface/newlogin/css/login.css">
...
<body>
<div class="main">
	<div class="logo-box"><img src="${base}/mainface/newlogin/images/logo.png" style="width:25%"></div>
	<div class="login-box">
		<div class="login-left">教育事业统计<br />国基报表系统</div>
		<div class="login-right">
			<form class="form-vertical login-form" action="${base}/loginbk.action" method="post" style="" name="lgfrm">
				<@s.token />
				<!--
					<div class="tips">你还没有账户？<a href="#">马上注册</a></div>
				-->
				<div class="tips">系统登录</div>
				...
				<div class="login-item control-group code-box">
					...
					<div class="code-img">
						<a href="javascript:;" onclick="refreshYzm()">
							<img id="captchaImg" src="${base}/jcaptcha.jpg?jcaptchafilter=1"  width=120 height=36 />
						</a>
					</div>
				</div>
				<!--
	...
	<div class="footer">Copyright © TQ</div>
</div>
<script type="text/javascript" src="${base}/mainface/newlogin/js/jquery360.min.js"></script>
<script type="text/javascript" src="${base}/mainface/js/jquery.validate.min.js" ></script>
<script type="text/javascript" src="${base}/mainface/layer/layer.js"></script>

<script type="text/javascript">	
function refreshYzm(){
	$("#captchaImg").attr("src","${base}/jcaptcha.jpg?jcaptchafilter=1&ra="+Math.random());
	//alert("aa");
	//document.getElementById("#captchaImg").src="${base}/jcaptcha.jpg?jcaptchafilter=1";
}
$(function(){ 
	//多选按钮
...
<script>
	...
	<#if Request['promptInfo']?exists>
		...
		layer.msg("${Request['promptInfo']!}");			
	</#if>
	<#if Parameters['error']?exists && Parameters['error'] == "9">
		//alert("验证码错误!");
		layer.msg("验证码错误!");
	</#if>
