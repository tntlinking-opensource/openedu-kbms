...
Popup.prototype = {
	...
	build: function() {
		...
		var close = '<input type="button" id="dialogBoxClose" border="0" width="16" height="16" align="absmiddle" title="关闭"/>';
	...
	middle: function() {
		...
		//old--var iTop = (sClientHeight / 2 + sScrollTop) - (oDialog.offsetHeight / 2);
		var iTop = (window.screen.availHeight / 2 + sScrollTop) - (oDialog.offsetHeight);
		//alert(iTop);
		//alert(sClientHeight);
		//alert(oDialog.offsetHeight);
